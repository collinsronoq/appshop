...
export type Memory={household_product_id:string;name:string;brand?:string|null;size_value?:number|null;size_unit?:string|null;last_purchased_at:string;purchase_count:number;archived:boolean};
